...
insert into Empleado (Nombre, Telefono, Usuario, Password, Jerarquia) values ('', '', 'RafaelZamora'. sha1(), 1);
insert into Empleado (Nombre, Telefono, Usuario, Password, Jerarquia) values ('', '', 'RafaelZamora'. sha1(), 1);
...
insert into Producto (Cod_Barras, Descripcion, Presentación, Proveedor, Precio_Compra, Precio_Venta, Cantidad, Receta, idCategoria) 
    values ('7501031311309', 'Pepsi 355ML', 1, 'Pepsico', 8.0, 10.0, 0, 0, 1);
insert into Producto (Cod_Barras, Descripcion, Presentación, Proveedor, Precio_Compra, Precio_Venta, Cantidad, Receta, idCategoria)
    values ('7501031311606', 'Pepsi 2L', 2, 'Pepsico', 12.0, 15.0, 0, 0, 1);
insert into Producto (Cod_Barras, Descripcion, Presentación, Proveedor, Precio_Compra, Precio_Venta, Cantidad, Receta, idCategoria)
    values ('036731501004', 'Gatorade Naranja 500ML', 2, 'Pepsico', 10.0, 13.0, 0, 0, 1);
