...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Farmacia`.`Reporte de utilidades` (`idVenta` INT, `idProducto` INT, `Descripcion` INT, `'Precio de compra'` INT, `'Precio de venta'` INT, `Cantidad` INT, `'Total'` INT, `'Promocion'` INT, `'Utilidad'` INT, `Fecha` INT);
...
Detalle_Venta.Precio_Compra As 'Precio de compra',
((select Precio_Venta from Producto where Producto.idProducto = Detalle_Venta.idProducto)) As 'Precio de venta', 
Detalle_Venta.Cantidad,
Detalle_Venta.Cantidad * Detalle_Venta.Precio_Venta As 'Total',
(select Descripcion from Promocion where idPromocion = Detalle_Venta.Promocion) As 'Promocion',
((Detalle_Venta.Precio_Venta * Detalle_Venta.Cantidad) - (Detalle_Venta.Precio_Compra * Detalle_Venta.Cantidad)) As 'Utilidad',
Venta.Fecha
...
BEGIN
	...
	where new.idCliente = Cliente.idCliente and new.idCliente != 1;
END$$
