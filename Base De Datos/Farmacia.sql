...
Detalle_Venta.Cantidad * Detalle_Venta.Total As 'Total',
(select Descripcion from Promocion where idPromocion = Detalle_Venta.Promocion) As 'Promocion',
((Detalle_Venta.Total * Detalle_Venta.Cantidad) - (Detalle_Venta.Precio_Compra * Detalle_Venta.Cantidad)) As 'Utilidad',
Venta.Fecha
