...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Farmacia`.`Reporte Promociones` (`Descripcion` INT, `Activa` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Farmacia`.`Reporte de utilidades` (`idVenta` INT, `idProducto` INT, `Descripcion` INT, `'Precio de compra'` INT, `'Precio de venta'` INT, `Cantidad` INT, `'Total'` INT, `'Utilidad'` INT);
...
concat('$', Detalle_Venta.Precio_Venta) As 'Precio de venta', 
Detalle_Venta.Cantidad,
concat('$', Detalle_Venta.Cantidad * Detalle_Venta.Precio_Venta) As 'Total',
concat('$', ((Detalle_Venta.Precio_Venta * Detalle_Venta.Cantidad) - (Detalle_Venta.Precio_Compra * Detalle_Venta.Cantidad))) As 'Utilidad'
